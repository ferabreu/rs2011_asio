...
- Copy the files `avrt.dll`, `RS_ASIO.dll` and `RS_ASIO.ini` of [latest release](https://github.com/ferabreu/rs2011-asio/releases/latest) (zip archive rs2011-asio-\<VERSION\>.zip ) to the game folder.
